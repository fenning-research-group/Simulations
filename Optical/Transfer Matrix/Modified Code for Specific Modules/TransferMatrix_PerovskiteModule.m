...
function TransferMatrix_PerovskiteModule
%------------BEGIN USER INPUT PARAMETERS SPECITIFCATION---------------
%
lambda=300:10:2000; % Wavelengths over which field patterns are calculated
...
layers = {'lowFeglass' 'ITO' 'TiO2' 'MAPI' 'SPIRO' 'Au'}; % Names of layers of materials starting from side light is incident from
thicknesses = [2.3e6 500 30 500 200 80];  % thickness of each corresponding layer in nm (thickness of the first layer is irrelivant)
...
[IndRefr,IndRefr_names]=xlsread('perovskite_refractive_indices.xls');
